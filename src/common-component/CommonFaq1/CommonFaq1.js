    ...
    return (
        <div className=" py-7 ">
            <div className='flex gap-2 w-fit m-auto'>
                ...
                <h2 className="dm_sans responsiveheading3 mb-5 flex w-fit m-auto items-center gap-2">{`FAQs `}{""}{title}</h2>
            </div>
            {faqData?.map((item, index) => (
             ...
             ${expanded === index
                        ...
                        <div className="flex gap-3 ">
                            ...
                            <h3 className={`responsive-text dm_sans font-medium  text-[#1A2E33] ${expanded === index ? "text-[#1D1C1C]" : "text-[#1A2E33]"}`}>{item.question}</h3>
                        </div>
                        {expanded === index && (
