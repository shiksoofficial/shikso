      ...
      <div className="mx-auto bg-white p-6 md:p-10 rounded-xl shadow">
        ...
        <div className="border-gray-300 border-1 rounded-xl p-6 bg-white mt-4">
          <div className="flex justify-between items-center mb-6">
            ...
            <span className="dm_sans responsive-test bg-green-100 text-green-700 px-3 py-1 rounded-full ">
              {languages}
            </span>
          </div>
            ...
            {testList.map((test, index) => (
              ...
              >
                ...
                <div className="flex items-center gap-2 mt-3 sm:mt-0">
                  <span
                    className={`px-3 py-1 rounded-full dm_sans responsive-test  font-medium ${
                      test.status === "Free"
