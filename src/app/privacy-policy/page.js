    ...
    return (
        <>
            ...
            <div className="custom-container bg-white">
                <h2 className="dm_sans  responsiveheading2 text-[#1A2E33] font-medium mt-10 mb-2">{`1. Introduction`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2  ">{`Welcome to `}<strong className='font-bold'>{` Shikso`}</strong>{` , an AI-powered smart learning platform dedicated to making education engaging, affordable, and accessible.`}</p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2  ">{`This Privacy Policy explains how we collect, use, disclose, retain and protect your personal information when you :`}</p>
                <ul className="dm_sans responsive-text list-disc px-6 font-medium text-[#1A2E33] mb-1 ">
                    <li>{`visit our website,`}</li>
                    <li>{`use our mobile application, or`}</li>
                    <li>{`otherwise interact with our services (“Platform”).`}</li>
                </ul>

                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2  ">{`By accessing or using our Platform, you accept the practices described in this policy. If you do not agree with this policy, please do not use or access the Platform.`}</p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2  ">{`We are committed to protecting your privacy and securing your personal data in compliance with applicable laws and best practices (for example as seen in comparable policies such as those of established edtech providers).`}</p>
                <h2 className="dm_sans  responsiveheading2 text-[#1A2E33] font-medium  mb-2">{`2. Information We Collect`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`3. How We Use Your Information`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`4. Data Security & Retention`}</h2>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium  mb-5 sm:mb-7 ">
                ...
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2  ">{`For any privacy-related concerns, please reach out:`}</p>
                ...
                <p className="dm_sans responsive-text text-[#1A2E33] mt-12 mb-12">
