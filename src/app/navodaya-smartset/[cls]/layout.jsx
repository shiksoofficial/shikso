...
//       <div
//         id="tabs-sentinel dm_sans"
//         style={{ height: "1px", paddingTop: "64px" }}
//       />

//       <div id="section-tabs-bar" className="section-tabs-bar">
...
//               <Link
//                 key={sec.slug}
//                 href={navodayaHref(cls, sec.slug, "/navodaya-smartset")}
//                 className="tab-link dm_sans"
//               >
//                 {sec.icon} {sec.label}
//               </Link>
//             ))}
...
//               var bar = document.getElementById('section-tabs-bar');
...
// app/navodaya-smartset/[cls]/layout.jsx
    ...
    <>
      ...
      <script
        dangerouslySetInnerHTML={{
          __html: `
            (function() {
              var sentinel = document.getElementById('navodaya-tabs-sentinel');
              var bar = document.getElementById('navodaya-tabs-bar');
              if (!sentinel || !bar) return;
              var observer = new IntersectionObserver(function(entries) {
                bar.classList.toggle('is-sticky', !entries[0].isIntersecting);
              }, { threshold: 0 });
