    ...
    return (
        <>
            ...
            <div className="custom-container bg-white">
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mt-5 mb-5"><strong className='font-bold'>{`Disclaimer  – Shikso`}</strong></h2>
                <p className="dm_sans responsive-text text-[#1A2E33] mt-4 mb-7">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`1. General Information`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2 ">{`Under no circumstances shall `} <strong className="font-bold">{` Shikso, its owners, employees, or partners `}</strong>{` be held responsible for any direct, indirect, incidental, or consequential damages resulting from:`}</p>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`2. Educational Content`}</h2>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`3. External Links & Third-Party Content`}</h2>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`4. Professional Advice Disclaimer`}</h2>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`5. Limitation of Liability`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2 ">{`Under no circumstances shall Shikso, its owners, officers, employees, affiliates or partners be liable for any direct, indirect, incidental, special, consequential or punitive damages resulting from :`}</p>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`6. Use At Your Own Risk & “As-Is” Basis`}</h2>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`7. Consent`}</h2>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`8. Updates to This Disclaimer`}</h2>
                <ul className="dm_sans responsive-text list-disc px-6  text-[#1A2E33]  font-medium mb-5 sm:mb-7 ">
                ...
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2  ">{`If you have any questions, concerns or require clarification regarding this Disclaimer, please reach out to us:`}</p>
