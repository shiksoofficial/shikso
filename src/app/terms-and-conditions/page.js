    ...
    return (
        <>
            ...
            <div className="custom-container bg-white">
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mt-5 mb-5 sm:mb-7"><strong className='font-bold'>{`Terms & Conditions – Shikso`}</strong></h2>
                ...
                <h2 className="dm_sans  responsiveheading2 text-[#1A2E33] font-medium mt-5 mb-2">{`1. Introduction`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`2. Purpose of the Platform`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`3. Acceptance of Terms`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`4. Eligibility to Use`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`5. Account Creation & Responsibilities`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-1   ">{`To access personalized dashboards, mock tests, SmartSets, and progress analytics, you need to`}<strong className='font-bold'>{`  create a Shikso account.`}</strong></p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-2   ">{`  During registration, you must:`}</p>
                <ul className="dm_sans responsive-text list-disc px-6  font-medium text-[#1A2E33] mb-3     ">
                ...
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-5 sm:mb-7  ">{`You are fully responsible for all actions under your account. If we find suspicious, fraudulent, or abusive activity, we may suspend or permanently deactivate your account.`}</p>
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`6. Use of the Platform`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`7. Subscription, Payments & Refunds`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`8. Intellectual Property Rights`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-1   ">{`All materials, including questions, videos, animations, study notes, designs, logos, and software, are the `}<strong className='font-bold'>{`  intellectual property of Shikso.`}</strong>{``}</p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-1   ">{` You are granted a `}<strong className='font-bold'>{`  limited, non-transferable, non-exclusive license `}</strong>{` to access and use the platform for your personal learning.`}</p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-3  ">{`You`}<strong className='font-bold'>{` must not : `}</strong></p>
                <ul className="dm_sans responsive-text list-disc px-6  font-medium text-[#1A2E33] mb-3">
                ...
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-5 sm:mb-7  ">{`Violation of these rights may lead to legal action under copyright and trademark laws.`}</p>
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`9. User-Generated Content`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-1   ">{`When you upload, post, or share content (e.g., comments, notes, feedback, or test questions), you :`}</p>
                <ul className="dm_sans responsive-text list-disc px-6  font-medium text-[#1A2E33] mb-3">
                ...
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-5 sm:mb-7  ">{`Shikso reserves the right to `}<strong className='font-bold'>{`moderate, edit, or remove `}</strong>{`any user content that violates our guidelines or legal standards.`}</p>
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`10. Accuracy of Information`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`11. Limitation of Liability`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`12. Disclaimer of Warranties`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-1   ">{`Shikso is provided on an`}<strong className='font-bold'>{`  “as is” and “as available” `}</strong>{` basis.`}</p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-3   ">{` We make no express or implied warranties regarding :`}</p>
                <ul className="dm_sans responsive-text list-disc px-6  font-medium text-[#1A2E33] mb-3">
                ...
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-5 sm:mb-7  ">{`You acknowledge that using Shikso means accepting these inherent limitations.`}</p>
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`13. Data Privacy & Security`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-1   ">{`Your privacy is extremely important to us.`}</p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-1   ">{` All personal data collected by Shikso is handled in accordance with our `}<strong className='font-bold'>{`Privacy Policy. `}</strong></p>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-3   ">{`We ensure:`}</p>
                <ul className="dm_sans responsive-text list-disc px-6  font-medium text-[#1A2E33] mb-3">
                ...
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium  mb-5 sm:mb-7  ">{`However, no digital platform can be 100% secure. Users are encouraged to maintain safe browsing habits and report any suspicious activity.`}</p>
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`14. Links to Third Parties`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`15. Termination of Access`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`16. Indemnification`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`17. Modifications to Services`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`18. Updates to Terms`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`19. Governing Law & Jurisdiction`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`20. Entire Agreement`}</h2>
                ...
                <h2 className="dm_sans responsiveheading2 text-[#1A2E33] font-medium mb-2  ">{`21. Communication & Contact`}</h2>
                <p className="dm_sans responsive-text text-[#1A2E33]  font-medium mb-2  ">{`For questions, feedback, or clarification regarding these Terms, please contact us at :`}</p>
