// app/navodaya-entrance-exam/[cls]/updates/page.tsx
...
function getFaqs(cls) {
  ...
  return [
    ...
    },
    {
      ...
      a: 'The Class 9 exam is based on the <strong>NCERT syllabus of Classes 6, 7, and 8</strong>. It covers Mathematics, Science, English, Hindi, and Social Science. Visit the <a href="/navodaya-entrance-exam/class-9/syllabus" style="color:var(--primaryColor);font-weight:700;">Syllabus page</a> for the full topic-wise breakdown.',
    },
    ...shared,
  ];
}
