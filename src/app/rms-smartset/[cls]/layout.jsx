...
// Sticky section tab bar — exact same pattern as navodaya-smartset/[cls]/layout.jsx

import Link from "next/link";
import { notFound } from "next/navigation";
import { usePathname } from "next/navigation";
import { RMS_SECTIONS, RMS_CLASS_LABELS, RMS_CLASSES, rmsHref, isRMSClass, normalizeRMSClass } from "@/component/rms/rmsNav";
      ...
      <div id="rms-tabs-bar" className="section-tabs-bar">
        <div className="tabs-container">
          <div className="tabs-left">
            <span className="tabs-prefix">🏫 {RMS_CLASS_LABELS[cls]} &rsaquo;</span>
