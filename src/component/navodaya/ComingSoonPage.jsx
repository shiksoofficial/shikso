// components/navodaya/ComingSoonPage.tsx
import Link from "next/link";
import { CLASS_LABELS, NAVODAYA_SECTIONS, navodayaHref } from "./navodayaNav";
    ...
    <main>
      <section className="cs-hero dm_sans">
        <div className="container">
          <nav className="breadcrumb" aria-label="breadcrumb">
            ...
            <Link href={basePath}>Navodaya SmartSet</Link> &rsaquo;{" "}
            <Link href={navodayaHref(cls, undefined, basePath)}>{label}</Link>{" "}
      ...
      <div className="container cs-body dm_sans">
        <div className="cs-card">
          ...
          <p>
            {sectionMeta.label} for Navodaya {label} is currently being prepared
            by our content team. Join the waitlist to be notified the moment it
            goes live.
          </p>
        ...
        <div className="cs-other">
          ...
          <div className="cs-other-grid">
            {NAVODAYA_SECTIONS.filter(
              ...
              <Link
                key={sec.slug}
                href={navodayaHref(cls, sec.slug, basePath)}
                className="cs-other-card"
              >
                <span className="oc-icon">{sec.icon}</span>
                <div>
