...
export const NAVODAYA_SECTIONS = [
  {
    ...
    icon: "📢",
    description:
      "Exam dates, form dates, admit card, result — all official JNVST info",
  },
  {
    label: "Syllabus",
    slug: "syllabus",
    icon: "📚",
    description:
      "Complete topic-wise syllabus aligned to official JNVST pattern",
  },
  {
    ...
    icon: "📄",
    description:
      "Solve real JNVST papers year-by-year with solutions and hints",
  },
  {
    label: "Mock Tests",
    slug: "mock-tests",
    icon: "🏆",
    description:
      "Full-length timed mock tests matching the official JNVST pattern",
  },
  {
...
export function navodayaHref(
  cls,
  sectionSlug,
  routeBase = "/navodaya-entrance-exam",
) {
