...
const cardsData = [
  {
    ...
    description1:
      " Includes previous papers, topic-wise practice, AI analytics, and gamified tests to make preparation easy, engaging, and result-oriented.",
  ...
  },
  {
    ...
    description1:
      " Perfect for Class 6 & 9 aspirants — designed to make disciplined learning exciting and measurable.",
