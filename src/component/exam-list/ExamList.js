    ...
    <div className="min-h-screen" style={{ backgroundColor: "#f8fafc" }}>
      ...
      >
        ...
        <div
          ...
          style={{
            background: "radial-gradient(circle, #4ED7F2, transparent)",
        ...
        <div className="max-w-5xl mx-auto text-center relative z-10">
          <span
            ...
            style={{
              backgroundColor: "rgba(78,215,242,0.15)",
              color: "#4ED7F2",
              border: "1px solid rgba(78,215,242,0.3)",
            }}
          >
            All Exams
          </span>
          ...
          <p
            ...
            style={{ color: "#94a3b8" }}
          >
            India's top school entrance exams — all in one place. Get free
                  ...
                  <div className="flex flex-col gap-3 shrink-0 md:min-w-[160px]">
                    <Link
                      ...
                      style={{
                        ...
                        boxShadow: `0 4px 14px ${exam.accentColor}40`,
                      }}
                    >
                      Start Preparing →
                    </Link>
